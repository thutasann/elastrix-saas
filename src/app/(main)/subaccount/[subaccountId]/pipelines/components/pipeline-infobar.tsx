...
import CreatePipelineForm from '@/components/organisms/forms/create-pipeline-form'
            ...
            <Command>
              ...
              <CommandList className='mt-2'>
                ...
                <CommandGroup>
                  ...
                  <Button variant='secondary' className='mt-4 flex w-full gap-2' onClick={handleClickCreatePipeline}>
                    <Plus size={15} />
                    Create Pipeline
                  </Button>
                </CommandGroup>
