...
import { UsersWithAgencySubAccountPermissionsSidebarOptions } from '@/dto/types/agency'
...
import { deleteUser, getUser } from '@/lib/server-actions/queries/subaccount-queries'
          ...
          <div className='flex flex-col gap-2'>
            {ownedAccounts?.length ? (
              ownedAccounts.map((account) => (
                <Badge key={account.id} className='w-fit whitespace-nowrap bg-slate-600'>
